...
int WINAPI wWinMain( _In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow )
{
    ...
    DXUTCreateWindow( L"MechManager" );
                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( DXUTCompileFromFile( L"Shaders/MechManager_VS.hlsl", nullptr, "VSMain", "vs_4_0_level_9_1", dwShaderFlags, 0, &pVertexShaderBuffer ) );

    ID3DBlob* pPixelShaderBuffer = nullptr;
    V_RETURN( DXUTCompileFromFile( L"Shaders/MechManager_PS.hlsl", nullptr, "PSMain", "ps_4_0_level_9_1", dwShaderFlags, 0, &pPixelShaderBuffer ) );
